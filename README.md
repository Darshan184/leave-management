...
```bash
leave-management$ sam logs -n StockCheckerFunction --stack-name leave-management --tail
```
...
```bash
leave-management$ cd functions/<function-name>/
...
```bash
sam delete --stack-name leave-management
```
